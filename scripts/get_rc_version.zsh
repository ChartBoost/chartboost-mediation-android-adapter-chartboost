...
curl -sSf -u "$JFROG_USER:$JFROG_PASS" -O 'https://cboost.jfrog.io/artifactory/private-chartboost-mediation/com/chartboost/chartboost-mediation-adapter-chartboost/maven-metadata.xml'
